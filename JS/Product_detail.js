...
const pla_obj = {
    ...
    oil: {
        ...
        data: [
            { 
                id:25,imgSrc: './Assets/PlaAssets/plaBadam.jpeg', productName: 'Badam',price: `100`, oprice: `190`, description: `<li>Purely natural, no additives, no preservatives or added flavours.</li>
            ...
            <li>Hygienically packed in a pouch, meeting FSSAI food safety standards, that keeps the goodness intact.</li>`, small: [
                './Assets/small_images/Badam1.jpg',
                './Assets/small_images/Badam2.jpg',
                './Assets/small_images/Badam3.webp'] },
            { id:26,imgSrc: './Assets/PlaAssets/plaCastorSeed.jpeg', productName: 'CastorSeed',price: `100`, oprice: `190`, description: `<li>Pure and natural.</li>
            ...
            { id:27,imgSrc: './Assets/PlaAssets/plaCornOil.jpeg', productName: 'Corn',price: `100`, oprice: `190`, description: `<li>Corn oil is a feedstock used for biodiesel.
            </li>
            <li>It has anticholesterol properties as it lowers LDL blood cholesterol.</li>
            <li>Corn oil reduces blood pressure post consumption in hypertensive patients.</li>`, small: [
                './Assets/small_images/Corn1.webp',
                './Assets/small_images/Corn2.jpg',
                './Assets/small_images/Corn3.jpg'] },
            { id:28,imgSrc: './Assets/PlaAssets/plaFlaxSeeds.jpeg', productName: 'FlaxSeeds',price: `100`, oprice: `190`, description: `<li>GNC flax seed oil capsules are made with unrefined cold pressed flaxseeds.</li>
            <li>Perfect vegetarian alternative for fish oil.<li>
            <li>Provides both omega 3 and omega 6 fatty acids.<li>`, small: [
                './Assets/small_images/FlaxSeeds1.jpg',
                './Assets/small_images/FlaxSeeds2.webp',
                './Assets/small_images/FlaxSeeds3.jpg'] },
            {id:29, imgSrc: './Assets/PlaAssets/plaMustardSeeds.jpeg', productName: 'MustardSeeds',price: `100`, oprice: `190`, description: `<li> This mustard oil is rich in Vitamin E, a natural antioxidant.</li>
            <li>This cold pressed mustard oil is good for your well-being as it is cholesterol free.</li>
            <li>Bring home the goodness of pure mustard seed.</li>`, small: [
                './Assets/small_images/MustardSeeds1.jpg',
                './Assets/small_images/MustardSeeds2.jpg',
                './Assets/small_images/MustardSeeds3.jpg'] },
            { id:30,imgSrc: './Assets/PlaAssets/plaHembSeed.jpeg', productName: 'HembSeed',price: `100`, oprice: `190`, description: `<li> Hemp Seed Oil has many medicinal properties that include Dry Skin Moisturization, Anti-Aging Effect, treating Dermatitis & enhance the overall quality & texture of your skin & hair. It makes them healthy again.</li>
            ...
            <li>This is Pure and Unrefined Hemp Seed Oil.</li>`, small: [
    ...
    grains: {
        heading: 'All Grains',
        data: [
            { id:37,imgSrc: './Assets/PlaAssets/plaBarely.avif', productName: 'Barely',price: `100`, oprice: `190`, description: `<li>Barley is a form of barley that has been processed to remove its fibrous outer hull and polished to remove some or all of the bran layer.</li>
            <li>It is the most common form of barley for human consumption because it cooks faster and is less chewy than other.</li>
            <li>Pearls are high in protein, iron, and natural fiber, and also contain small amounts of calcium & fat. Cooks can be very innovative with pearled barley preparations.</li>`, small: [
                './Assets/small_images/barley6.webp',
                './Assets/small_images/Barely5.jpg',
                './Assets/small_images/Barely2.webp']  },
            { id:38,imgSrc: './Assets/PlaAssets/plaBasmatiRice.jpeg', productName: 'BasmatiRice',price: `100`, oprice: `190`, description: `<li>PREMIUM QUALITY: Our Daawat Biryani Basmati Rice is known for its exceptional quality and flavours, sourced from the finest basmati rice grains. We pick up the finest grains to serve you the finest basmati. Each pack is prepared after Chunkar, Bachakar, Sambhalkar and Sajaakar to serve you the longest rice grain.</li>
            ...
            <li>These Basmati rice grains are renowned for their impressive length, making them the world's longest rice grain. This unique characteristic adds to the overall appeal of your biryani dish.</li>`, small: [
                './Assets/small_images/BasmatiRice2.jpg',
                './Assets/small_images/BasmatiRice1.jpg',
                './Assets/small_images/BasmatiRice3.webp']  },
            { id:39,imgSrc: './Assets/PlaAssets/plaBlackRice.jpeg', productName: 'BlackRice',price: `100`, oprice: `190`, description: `<li>Rich in Antioxidants: Black rice is packed with antioxidants, particularly anthocyanins. These antioxidants help combat free radicals in the body, reducing oxidative stress and lowering the risk of chronic diseases.</li>
            ...
            <li>Black rice is naturally gluten-free, making it suitable for individuals with gluten sensitivities or celiac disease.</li>`, small: [
                './Assets/small_images/BlackRice1.jpg',
                './Assets/small_images/BlackRice5.jpg',
                './Assets/small_images/BlackRice3.jpg']  },
            { id:40,imgSrc: './Assets/PlaAssets/plaBrownRice.jpeg', productName: 'BrownRice',price: `100`, oprice: `190`, description: `<li>Used finest quality basmati.</li>
            <li>Suitable for all food.</li>
            <li>Country of Origin: India.</li>`, small: [
                './Assets/small_images/BrownRice1.webp',
                './Assets/small_images/BrownRice2.webp',
                './Assets/small_images/BrownRice3.jpg']  },
            { id:41,imgSrc: './Assets/PlaAssets/plaKaniwa.jpeg', productName: 'RedRice' ,price: `100`, oprice: `190`, description: `<li>Organic Red Rice. Eat Natural Live Healthy and phytochemicals.<li>
            <li>Much like the brown rice and white rice, red rice also comes with some incredible health benefits.</li>
            <li>Best Organic Grocery & Gourmet in india. Health Is Wealth So Give It A Try For Healthier Life.</li>`, small: [
                './Assets/small_images/Redrice1.webp',
                './Assets/small_images/Redrice2.jpeg',
                './Assets/small_images/Redrice3.png'] },
            { id:42,imgSrc: './Assets/PlaAssets/plaFreekeh.jpeg', productName: 'Freekeh',price: `100`, oprice: `190`, description: `<li>good source of essential nutrients, including protein, fiber, vitamins, and minerals. It contains B vitamins, such as niacin, thiamine, and riboflavin, as well as minerals like iron, phosphorus, magnesium, and zinc.</li>
            <li>Avocado by-products exert anti-proliferative and anti-inflammatory activities.</li>
            <li>Avocado seeds phytochemical improves carbohydrate and lipid metabolism.</li>`, small: [
    ...
    dry_fruits: {
        ...
        data: [
            {id:49,imgSrc: './Assets/PlaAssets/plaBetelNuts.jpeg', description: "", productName: 'BetelNuts',price: `100`, oprice: `190`, description: `<li>
            Last longs, Preserved Flavor & Freshness with Nitrogen Packing.</li>
            <li>Packed & Processed under Fully Hygienic Environment.</li>
            <li>100% Vegetarian.</li>`, small: [
                './Assets/small_images/BetelNuts1.jpg',
                './Assets/small_images/BetelNuts2.jpeg',
                './Assets/small_images/BetelNuts3.png']  },
            {id:50,imgSrc: './Assets/PlaAssets/plaBlackRaisin.jpeg', productName: 'BlackRaisin',price: `100`, oprice: `190`, description: `<li>Premium seedless Afghani Black Raisins that are famous for their sweetness as a ready to go snack. Imported from Afghanistan, these raisins are plump, luscious and flavoursome. You are going to relish each and every bite of it.</li>
            ...
            <li>Black raisins are one of the most nutritious dried fruits in the world. It can support digestion, improve iron levels and also helps keep the blood free from impurities.</li>`, small: [
                './Assets/small_images/BlackRaisin1.jpeg',
                './Assets/small_images/BlackRaisin2.jpeg',
                './Assets/small_images/BlackRaisin3.jpeg']  },
            { id:51,imgSrc: './Assets/PlaAssets/plaCashewnut.jpeg', productName: 'Cashewnut',price: `100`, oprice: `190`, description: `<li>Rich, buttery and delicious and perfect for making raw cashew milk or snacking. Excellent source of protein, fiber and minerals. Suitable for vegetarians.</li>
            ...
            <li>Cashew nuts are rich in fibre, heart-healthy fats, and plant protein. Good for an active life style, perfect for snacking.</li>`, small: [
                './Assets/small_images/Cashewnut1.jpeg',
                './Assets/small_images/Cashewnut2.webp',
                './Assets/small_images/Cashewnut3.webp']  },
            { id:52,imgSrc: './Assets/PlaAssets/plaDates.jpeg', productName: 'Dates',price: `100`, oprice: `190`, description: `<li>Dates are well known instant energy boosters. Dates contain several nutrients that give various health benefits from helping reduce cholesterol to healthy bones.</li>
            ...
            <li>100% Naturally Dried and free from any Preservatives and Additives, it is a healthy substitute for sugar in any dessert, smoothies or sweet treats.</li>`, small: [
                './Assets/small_images/Dates1.webp',
                './Assets/small_images/Dates2.png',
                './Assets/small_images/Dates3.webp']  },
            {id:53,imgSrc: './Assets/PlaAssets/plaDryBadam.jpeg', productName: 'Badam',price: `100`, oprice: `190`, description: `<li>Uniformly roasted crunchy nuts.</li>
            <li>Nitrogen flushed packs for extra freshness.</li>
            <li>Resealable zip lock stand up pouches.</li>`, small: [
                './Assets/small_images/Badam4.jpeg',
                './Assets/small_images/Badam5.png',
                './Assets/small_images/Badam7.webp']  },
            { id:54,imgSrc: './Assets/PlaAssets/plaDryFig.jpeg', productName: 'DryFig',price: `100`, oprice: `190`, description: `<li>They are highly nutritious and rich in healthy fats antioxidants vitamins and minerals.</li>
            <li>Naturally dried and free from any additives or preservatives.</li>
            <li>Bone Health: Premium Anjeer is a good source of calcium, which is essential for maintaining strong bones and preventing conditions like osteoporosis.</li>`, small: [
